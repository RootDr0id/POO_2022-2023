 ...
 * This class handles all user input and logic for the GUI of "Authentification" page<br>
...
/**
 * Event handler of the connexion button
 * Sets up input controlls for the user and password fields
 * Allows to switch to the main application after a successful authentification 
 */
    @FXML
    ...
    @FXML
     private void butteffectin(MouseEvent event) {
        ...
        else loginbutt.setEffect(colorAdjust);
    }
