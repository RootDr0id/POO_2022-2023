...
public class FournisseurController implements Initializable {
    ...
    private MFXTextField fieldmail;
     /**
     * The table field represents the table view that displays the list of all fournisseur
     */
    @FXML
    ...
    private MFXButton ajouterbutt;
      /**
     * Collection storing the list of suppliers from "Fournisseur.xlsx"
     * We use it to consturct the tableview
     */
    ...
    private  ExcelWorksheet myworksheet;
     /**
     * Workbook of the excel file storing the portfolio of suppliers "Fournisseur.xlsx"
     */
     ...
     * Loads the sourceData from the database of suppliers "Fournisseurs.xlsx"<br>
    ...
    public void initialize(URL url, ResourceBundle rb) {
     ...
     /**
     * Event handler for the button "Ajouter" which adds a new line in the table view of suppliers as well as its database
