...
public class ClientController implements Initializable {
    ...
    /**
     * The table field represents the table view that displays the list of all clients
     */
    @FXML
   ...
   /**
     * Event handler for the button "Ajouter" which adds a new line in the table view of clients as well as its database
