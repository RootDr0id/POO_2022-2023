 ...
 * It handles all user input and logic for the GUI of "Approvisionnement" page:<br>
...
public class AchatController implements Initializable{
    ...
    static 
    {
     ...
     /**
     * The table field represents the table view that displays the list of all new buys
     */
    @FXML
    ...
    private MFXFilterComboBox Fieldref;
      /**
     * The field button is the button "Confirmer" that triggers the buying operation 
     */
    @FXML
    ...
    /**
     * The field combofournisseur is a combobox containing a list of items which are all of the suppliers of the store<br>
    ...
    private AnchorPane grid;
     /**
     * Collection containing the list of products in the database "Inventaire.xlsx" for further manipulation<br>
     * We use it to construct the table view and alter the quantity of a product after a buying opperaton<br>
     */
    private ArrayList<ArrayList<String>> sourceData =new ArrayList();
     /**
     * Collection storing the list of suppliers<br>
     * We use it to populate the combobox containing the list of all suppliers "fournisseur"<br>
     */
    ...
    private ExcelWorksheet myfournisseursheet;
     /**
     * Workbook of the excel file storing the portfolio of providers Fournisseurs.xlsx
     */
	...
	Fieldref.setOnCommit(s -> {
     ...
     /**
     * Event handler for the button "Confirmer" which triggers the buy operation<br><br>
     ...
     * Takes dataS : Our data source containing all of the products in the database "Inventaire.xlsx" plus the ID of the product we're looking for<br>
     * Returns an arraylist which is a row in the databse containing the product with the specified ID<br>
     * Returns its index
     */
    public ArrayList<String> searchedrow(ArrayList<ArrayList<String>> dataS, String str ) {
     ...
     /**
     * Searches for the row in the databases "Fournisseurs.xlxsx" with the specified name in str <br><br>
     * Takes dataS: Our data source containing all of the providers "fournisseur" and the name of the provider we're looking for<br><br>
     * Returns an arraylist which is a row in the database containing the provider with the specified name
     */
