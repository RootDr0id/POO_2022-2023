 ...
 * It displays the list of all ins and outs of the stock in the form of bills<br>
 * Includes fiters<br>
...
public class JournalController implements Initializable {
    static 
    {
     ...
     /**
     * Collection containing the list of products in the database "Journal.xlsx" for further manipulation
    ...
    /**
     * The table field represents the table view that displays the list of the movements of the stock
     */
    @FXML
